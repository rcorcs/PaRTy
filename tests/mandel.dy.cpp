...
CREATE_DYNAMIC_THREAD(threadBody, Argument, 1, CHUNK_SIZE_1, int, i,
  {}
, 
...
//   testing each point to see whether it is inside or outside the set.
   ...
   LAUNCH_DYNAMIC_THREADS(num_threads, int, 0, NPOINTS, 1, CHUNK_SIZE_1, Argument, threadBody, 
