...
class Argument {
public:
   ChunkedWSContext<int> *ctx;
   unsigned threadId;
   int reduction;
   int PAD[8];
};

CREATE_CHUNKED_WS_THREAD(threadBody, Argument, 1, 16, int, i,
  {}
, 
...
//   testing each point to see whether it is inside or outside the set.
   ...
   LAUNCH_CHUNKED_WS_THREADS(num_threads, int, 0, NPOINTS, 1, 16, Argument, threadBody, 
