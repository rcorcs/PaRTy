...
CREATE_DYNAMIC_THREAD(threadBody, Argument, 1, CHUNK_SIZE_1, long long, i,
...
void run(long long n, int print){
  ...
  LAUNCH_DYNAMIC_THREADS(num_threads, long long, 0, n, 1, CHUNK_SIZE_1, Argument, threadBody, 
